...
@Component({
  ...
  standalone: true,
  imports: [BreadcrumbComponent, NotificationsComponent, FeatherModule, CommonModule],
...
export class DashboardComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  ngAfterViewInit(): void {
    ...
    const optionsPieChart = {
      ...
      colors: ['#0d6efd', '#0d6efdbf', '#0d6efd80'],
      chart: {
        height: 305,
        width: '100%',
        type: 'pie',
      ...
      labels: ['Primer Item', 'Segundo Item', 'Tercer Item'],
      dataLabels: {
        enabled: true,
        style: {
          fontFamily: 'Montserrat, sans-serif',
