...
export function recaptchaSettingsFactory(configService: ConfigService): RecaptchaSettings {
  return {
...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    // DEMO ONLY: intercepts auth calls with local mock data since this
    // portfolio demo has no access to the real backend.
    {
      provide: HTTP_INTERCEPTORS,
